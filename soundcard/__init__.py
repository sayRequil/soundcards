...
class soundcard:
  def __init__(name="",description="",filetype="mp4",sound="sound",package=["soundcard","sound"],build=False):
    ...
    if build == True:
      ...
      for pack in packages:
        ...
        card = open(p,"a")
        card.write(name + " " + description + " " + filetype + " " + sound + " " + package[0]) # Example: soundname sounddesc mp4 sound soundcard
